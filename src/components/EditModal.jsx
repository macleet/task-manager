...
export default ({taskId, name, dueDate, priority, notes, activeSeconds, tags, editTaskId, setEditTaskId}) => {
    ...
    const patchName = async () => {
        try {
            await axios.patch(`http://localhost:8000/task/nameChange/${taskId}`, { "newName": taskDetails.name });
        } catch (error) {
    ...
    const patchPriority = async () => {
        try {
            await axios.patch(`http://localhost:8000/task/priority`, { 
    ...
    const patchDueDate = async () => {
        try {
            await axios.patch(`http://localhost:8000/task/dateChange/${taskId}`, {	
